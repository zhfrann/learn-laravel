...
class FooBarServiceProviderTest extends TestCase
{
    ...
    {
        $helloService1 = $this->app->make(IHelloService::class);
        $helloService2 = $this->app->make(IHelloService::class);

        self::assertSame($helloService1, $helloService2);

        self::assertEquals("Halo John", $helloService1->hello("John"));
        self::assertEquals("Halo Doe", $helloService2->hello("Doe"));
    }
}
