...
use App\Data\PersonForCollection;
...
class CollectionTest extends TestCase
{
    ...
    public function testMapInto()
    {
        ...
        $result = $collection->mapInto(PersonForCollection::class);
        $this->assertEquals([new PersonForCollection("Eko")], $result->all());
    }
    ...
    public function testMapSpread()
    {
        ...
        $result = $collection->mapSpread(function ($firstName, $lastName) {
            ...
            $fullName = "$firstName $lastName";
            return new PersonForCollection($fullName);
        });

        $this->assertEquals([
            new PersonForCollection("Eko Kurniawan"),
            new PersonForCollection("Khannedy Setiawan"),
        ], $result->all());
    }
